class Recipe1sController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @recipe1.save
        ...
        format.json { render :show, status: :created, location: @recipe1 }
      else
  ...
  def update
    respond_to do |format|
      if @recipe1.update(recipe1_params)
        ...
        format.json { render :show, status: :ok, location: @recipe1 }
      else
  ...
  def destroy
    @recipe1.destroy
    respond_to do |format|
      format.html { redirect_to recipe1s_url, notice: 'Recipe1 was successfully destroyed.' }
  ...
  private
    ...
    def recipe1_params
      params.require(:recipe1).permit(:title, :instructions)
    end
end
